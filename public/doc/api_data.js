define({ "api": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://likulator.loc/api/v1/facebook/deleteUser"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://likulator.loc/api/v1/facebook/getProfile"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://likulator.loc/api/v1/facebook/getUsers/:all/:city/:friends"
      }
    ]
  }
] });